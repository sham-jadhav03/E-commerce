      ...
      <main className="max-w-6xl mx-auto px-4 md:px-8 mt-8">
        ...
        <section className="flex flex-col md:flex-row gap-12 mb-16">
          <div className="w-full md:w-1/2 space-y-4">
            {/* Gallery placeholder */}
            <div className="w-full aspect-[4/5] bg-[#f5f3f0] overflow-hidden group relative">
              {product.images && product.images.length > 0 ? (
                ...
                <div className="w-full h-full flex items-center justify-center text-[#7f7668] uppercase tracking-widest text-xs">No Image Available</div>
              )}
            </div>
              ...
              <div className="flex gap-3 overflow-x-auto pb-2">
                {product.images.map((img, i) => (
                  <button 
                    ...
                    className={`relative w-20 h-24 shrink-0 transition-all duration-300 ${activeImageIndex === i ? 'ring-2 ring-[#745a27] ring-offset-2' : 'opacity-60 hover:opacity-100'}`}
                  >
                    <img src={img.url} alt={`Thumb ${i}`} className="w-full h-full object-cover bg-[#f5f3f0]" />
                  </button>
                ))}
              </div>
            )}
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-center">
            <div className="space-y-6">
              <div>
                <span className="text-[10px] uppercase tracking-[0.2em] text-[#745a27] font-semibold mb-2 block">Base Product Details</span>
                <h2 className="font-serif text-4xl md:text-6xl leading-tight mb-4 uppercase tracking-tight">{product.title}</h2>
              </div>
              
              <p className="text-[#6e6258] text-lg leading-relaxed max-w-md font-light italic">
                "{product.description}"
              </p>
              
              <div className="pt-6 border-t border-[#e4e2df]">
                <div className="text-[10px] uppercase tracking-[0.2em] text-[#7f7668] mb-1">Base Price</div>
                <div className="text-3xl tracking-wider font-light text-[#1b1c1a]">
